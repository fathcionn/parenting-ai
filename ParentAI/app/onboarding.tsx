...
import { COLORS as DEFAULT_COLORS, DARK_COLORS, LIGHT_COLORS } from '../src/theme/colors';
...
const slides = [
  ...
  {
    icon: 'mic',
    titleKey: 'onboarding_record_title',
    textKey: 'onboarding_record_text',
    image:
  ...
  },
  {
    ...
    textKey: 'onboarding_progress_text',
    image:
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.textBlock}>
            ...
            <Text style={[styles.subtitle, isFinalSlide && styles.finalSubtitle]}>{t(slide.textKey)}</Text>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <View style={styles.dots}>
            {slides.map((item, dotIndex) => (
              <View key={item.titleKey} style={[styles.dot, dotIndex === index && styles.dotActive]} />
            ))}
          </View>

          <TouchableOpacity activeOpacity={0.88} onPress={next} style={styles.primaryButton}>
            <Text style={styles.primaryButtonText}>
              {isFinalSlide ? t('onboarding_get_started') : t('onboarding_next')}
            </Text>
